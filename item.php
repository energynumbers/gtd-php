...
if ($show['header']) {
  if ($_SESSION['useLiveEnhancements']) {
    ...
    ?>
    <link rel="stylesheet" href='wysiwyg.js/wysiwyg-editor.css'>
    <link rel="stylesheet" href='wysiwyg.js/font-awesome.css'>
    <script src='wysiwyg.js/wysiwyg.js'></script>
    <script src='wysiwyg.js/wysiwyg-editor.js'></script>
    <script src='wysiwyg.js/wysiwyg-editor.js'></script>
    <?php
